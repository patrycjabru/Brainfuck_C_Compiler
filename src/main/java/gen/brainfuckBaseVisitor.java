...
public class brainfuckBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements brainfuckVisitor<T> {
	 ...
	 */
	public T visitFile(brainfuckParser.FileContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	public T visitExpression(brainfuckParser.ExpressionContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	public T visitSign(brainfuckParser.SignContext ctx) { return visitChildren(ctx); }
}